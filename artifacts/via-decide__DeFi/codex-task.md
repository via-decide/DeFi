...
CONSTRAINTS
The GovernanceToken must track delegates and historical balances using binary search over the checkpoints array to ensure $O(\log N)$ gas costs when querying past block balances.
